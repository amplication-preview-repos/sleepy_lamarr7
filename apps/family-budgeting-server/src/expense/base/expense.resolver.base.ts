...
import { ExpenseType } from "../../expenseType/base/ExpenseType";
...
export class ExpenseResolverBase {
  ...
  @graphql.ResolveField(() => ExpenseType, {
    nullable: true,
    name: "expenseType",
  })
  async getExpenseType(
    ...
    const result = await this.service.getExpenseType(parent.id);
